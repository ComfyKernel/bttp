...
all: info $(BUILD)/$(O) check
	...
	@echo -en "[\e[34mBUILD\e[0m] Exiting\n"

info:
	@echo -en "[\e[32mINFO\e[0m]  [--Build & OS Info--]\n"
	@echo -en "[\e[32mINFO\e[0m]  Compiler         :" $(CP) "\n"
	@echo -en "[\e[32mINFO\e[0m]  Compiler Version : "
	@$CP -dumpversion
	@echo -en "[\e[32mINFO\e[0m]  Archive          :" $(AR) "\n"
	@echo -en "[\e[32mINFO\e[0m]  OS               :" $(shell uname -a)
	@echo -en "\n"
	@echo -en "[\e[32mINFO\e[0m]  Architecture     :" $(shell uname -m) "\n\n"

	@echo -en "[\e[32mINFO\e[0m]  [--Directory Info--]\n"
	@echo -en "[\e[32mINFO\e[0m]  Origin  :" $(ORIGIN)  "\n"
	@echo -en "[\e[32mINFO\e[0m]  Build   :" $(BUILD)   "\n"
	@echo -en "[\e[32mINFO\e[0m]  Include :" $(INCLUDE) "\n"
	@echo -en "[\e[32mINFO\e[0m]  Source  :" $(SOURCE)  "\n\n"

	@echo -en "[\e[34mBUILD\e[0m] Starting Build\n\n"
...
check:
	@echo -en "[\e[31mAR\e[0m] Checking contents of archive\n"
	@$(AR) -t $(BUILD)/$(O)

	@echo -en "\n"

clean:
	@echo -en "[\e[32mINFO\e[0m] Cleaning up\n"
	@echo -en "[\e[32mINFO\e[0m] Removing object files\n"
